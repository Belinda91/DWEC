class Juego{
    ...
    start(){
        zona_juego.setAttribute("width", 825);
        zona_juego.setAttribute("height", 600);
        zona_juego.style.border = "solid grey";
        document.body.appendChild(zona_juego);
        var x = zona_juego.getAttribute("width")/2;
        var y = zona_juego.getAttribute("height")-30;
        var dx = 2;
        var dy = 2;
        var paddleHeight = 10;
        var paddleWidth = 75;
        var paddleX = (zona_juego.getAttribute("width") - paddleWidth)/2;
        var rightPressed = false;
        var leftPressed = false;
        var bola = new Bola(x,y,1,1,15,"pink"); //Se crea objeto bola con las coordenadas
        bola.mueve();
...
class Bola{
    constructor(x,y,cx,cy,r,color){
        ...
        this.bola.setAttribute("width", 10);
        this.bola.setAttribute("height", 75);
    }
    mueve(){
       self = this;
...
window.onload = function () {
    ...
    base = new Base(200,470,20,100,"#5d00dd");
    arrayBloques = [];
